        ...
        <div>
            ...
            <div>
                <div className="project">
                    ...
                    Built with JavaScript, React, Node.js, HTML, and CSS</h6><a href="http://atriacca-devquotes.surge.sh/" target="_blank" rel="noopener noreferrer"><img src={require('./DevQuotes-no-border.png')} alt="Unable to render"/></a>
                </div>
                <div className="project">
                    ...
                    <a href="http://atriacca-zengarden.surge.sh/" target="_blank" rel="noopener noreferrer"><img src={require('./zen-garden-img.png')} alt="Unable to render"/></a>
                </div>
                <div className="project">
